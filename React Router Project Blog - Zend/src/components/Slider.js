        ...
        return (
            <div className="bg-faded p-4 my-4">
                ...
                <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                    ...
                    <div className="carousel-inner" role="listbox">
                        <div className="carousel-item active">
                            <img className="d-block img-fluid w-100" src="img/slide-1.jpg" alt="slide" />
                        ...
                        <div className="carousel-item">
                            <img className="d-block img-fluid w-100" src="img/slide-2.jpg" alt="slide" />
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        <div className="carousel-item">
                            <img className="d-block img-fluid w-100" src="img/slide-3.jpg" alt="slide" />
                            <div className="carousel-caption d-none d-md-block">
                ...
                <div className="text-center mt-4">
                    ...
                    <div className="text-heading text-muted text-lg">By<strong>Start Bootstrap</strong>
                    </div>
                </div>
            </div>
