                ...
                <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
                    <li>
                        <div className="logo-wrapper waves-light waves-effect waves-light">
                            <a href="#home">
                                <img src="http://mdbootstrap.com/img/logo/mdb-transparent.png" className="img-fluid flex-center" alt="hinh" />
                            </a>
                        </div>
                    </li>
                    <li>
              ...
              <i className="fa fa-angle-down rotate-icon" />
                ...
                <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                    <div className="float-left">
                        <a data-activates="slide-out" className="button-collapse" href="#home">
                    ...
                    <ul className="nav navbar-nav nav-flex-icons ml-auto">
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" href="#home" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
